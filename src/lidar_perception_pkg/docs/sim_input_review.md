...
raw 수신이 정상이어도 ROI 밖의 객체는 검출되지 않는다. 현재 X는 0~40 m,
Y는 -15~15 m이며, 2026-09-14 사용자 요청으로 확장했다. 현재 z 범위 -1.5~1.0 m는
2026-09-14 사용자 요청으로 확장한 센서 기준 범위다. 저장 프로필의 높이 1.5 m가 실제 지면 기준 높이와
