...
| 3D LiDAR | `Lidar3D-6`, ID 6 | `1.430, 0.000, 1.220` | `0, 0, 0` | 0.10 s | 2026-09-10 사용자 지정 위치 |
...
## LiDAR 장착 위치 갱신 (2026-09-10)

사용자 지정값 `base_link -> lidar_link` XYZ `[1.43, 0, 1.22] m`를 중앙 계약에 반영했다.
RPY는 `[0, 0, 0]`이며 사용자 좌표계 확인 및 즉시 활성화 요청에 따라 개발용 정적 TF 발행을 활성화했다.
