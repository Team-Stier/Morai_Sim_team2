...
인터페이스
- pub ~topic (기본 /molit/sensors/imu/data): sensor_msgs/Imu
...
from morai_udp_bridge.protocol import imu_packet
...
class MoraiImuBridge(object):
    ...
    def __init__(self):
        ...
        self.topic = rospy.get_param("~topic", "/molit/sensors/imu/data")
