...
인터페이스
- pub ~topic (기본 /molit/vehicle/twist): geometry_msgs/TwistWithCovarianceStamped
...
from morai_udp_bridge.protocol import ego_status_packet
...
class MoraiVehicleStatusBridge(object):
    ...
    def __init__(self):
        ...
        self.topic = rospy.get_param("~topic", "/molit/vehicle/twist")
